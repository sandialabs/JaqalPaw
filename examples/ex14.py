...
class GatePulse:
	...
	amplitude_scaling: float = [.97, .96, .95]

	def gate_G(self, qubit1, qubit2):
		global_aom_frequency = (self.aom_center_frequency +
								self.effective_qubit_splitting)
		...
		return [PulseData(GLOBAL_BEAM, 100e=6, freq0=rsb_freq,
						  freq1=bsb_freq, fb_enable_mask=0b11, sync_mask=0b11),
