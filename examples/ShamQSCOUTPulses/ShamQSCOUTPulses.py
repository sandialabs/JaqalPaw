...
class GatePulses:
    ...
    single_qubit_rabi_angle_calibrations: List[RabiCalibration] = [
        83.23671031e3,  # qubit 0
    ...
    stronger_motional_mode_frequencies: List[Frequency] = [
        2.3e6,
        2.35e6,
        2.42e6,
        2.5e6,
    ...
    weaker_motional_mode_frequencies: List[Frequency] = [
        2.0e6,
        2.05e6,
        2.12e6,
        2.18e6,
    ...
    stronger_motional_mode_rabi_calibrations_bsb: List[List[RabiCalibration]] = [
        [20e3, 21e3, 19e3, 23e3, 30e3],  # qubit 0
        [21e3, 20e3, 19e3, 21e3, 27e3],  # qubit 1
        [22e3, 19e3, 20e3, 22e3, 28e3],  # qubit 2
        [21e3, 20e3, 19e3, 21e3, 27e3],  # qubit 3
        [20e3, 21e3, 19e3, 23e3, 30e3],
    ]  # qubit 4

    stronger_motional_mode_rabi_calibrations_rsb: List[List[Frequency]] = [
        [10e3, 11e3, 19e3, 13e3, 30e3],  # qubit 0
        [11e3, 10e3, 19e3, 11e3, 17e3],  # qubit 1
        [11e3, 19e3, 10e3, 11e3, 18e3],  # qubit 2
        [11e3, 10e3, 19e3, 11e3, 17e3],  # qubit 3
        [10e3, 11e3, 19e3, 13e3, 30e3],
    ]  # qubit 4

    weaker_motional_mode_rabi_calibrations_bsb: List[List[Frequency]] = [
        [20e3, 21e3, 19e3, 23e3, 30e3],  # qubit 0
        [21e3, 20e3, 19e3, 21e3, 27e3],  # qubit 1
        [22e3, 19e3, 20e3, 22e3, 28e3],  # qubit 2
        [21e3, 20e3, 19e3, 21e3, 27e3],  # qubit 3
    ...
    weaker_motional_mode_rabi_calibrations_rsb: List[List[Frequency]] = [
        [10e3, 11e3, 19e3, 13e3, 30e3],  # qubit 0
        [11e3, 10e3, 19e3, 11e3, 17e3],  # qubit 1
        [11e3, 19e3, 10e3, 11e3, 18e3],  # qubit 2
        [11e3, 10e3, 19e3, 11e3, 17e3],  # qubit 3
    ...
    nominal_MS_gate_times: List[List[Time]] = [
        [0, 200e-6, 240e-6, 210e-6, 220e-6],  # -, MS01, MS02, MS03, MS04
    ...
    def amplitude_from_rabi_angle(rabi_angle, duration, calibration_factor):
        ...
        if amp > 100.0:
            raise PulseException(
                f"Maximum amplitude exceeded! rabi_angle={rabi_angle}, amp={amp}, duration={duration}, calibration_factor={calibration_factor}"
            )
        return amp
    ...
    def gate_R_copropagating_square(self, qubit, theta, phi):
        ...
        return [
            PulseData(
                qubit,
                self.duration_from_rabi_angle(
                    phi, 1.0, self.single_qubit_rabi_angle_calibrations[qubit]
                ),
                amp0=50.0,
                amp1=50.0,
