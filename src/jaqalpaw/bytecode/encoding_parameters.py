...
ANCILLA_COMPILER_TAG_SHIFT = 11  # bit used for tagging an ancilla sequences in GLUT
ANCILLA_STATE_OFFSET = 7  # number of bits to shift readout result in gate id
...
ANCILLA_WAIT_OFFSET = 245
CONTINUE_ANCILLA_OFFSET = 246
...
SLUT_BYTECNT = 220//(SLUTW+PLUTW)
GLUT_BYTECNT = 220//(GPRGW+2*SLUTW)
GSEQ_BYTECNT = 220//(GLUTW)
